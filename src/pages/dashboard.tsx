...
import { TitleColumnContainer } from "ui/components/DealComponents/DealCard/DealCard.style";
...
function Dashboard({ allDeals, token }: DashboardProps) {
  ...
  const [filterType, setFilterType] = useState<{
    chartType: string;
    valueType: string;
  }>({ chartType: "Vendedor", valueType: "Valor" });
  ...
  return (
    <DashboardPageContainer>
      <Head>
        <title>Dashboards | Wave CRM</title>
      </Head>
      <DashboardHeaderContainer>
        <h2 >Dashboards</h2>
        <DatePickerContainer>
          ...
          <div className="buttonEditChart" >
            ...
            >
              ...
              <ToggleButton value="Canal">Canais</ToggleButton>
            </ToggleButtonGroup>
            <ToggleButtonGroup
              color="primary"
