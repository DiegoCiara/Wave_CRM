...
const AutorizedAutomation = () => {
  return (
    <div>
      <Head>
        <title>Libere seu acesso a automações | Wave CRM</title>
      </Head>
      <ImageContainer>
        <img
          src="AutorizedAutomation.svg"
          alt="Seja bem vindo!"
          height="300 px"
          width="auto"
          text-align="center"
      ...
      <Title
        title={"Tenha acesso a suas automações"}
        subtitle={<p>Precisa automatizar seus envios de e-mails, atividades e mais?<br/>Escolha um plano e libere seu acesso a automações.</p>}
      ></Title>
...
export default AutorizedAutomation;
