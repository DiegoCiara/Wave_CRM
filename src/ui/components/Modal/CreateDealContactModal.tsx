...
const CreateDealContactModal = ({ getData, selectedPipelines }: DetailModalProps) => {
  const {
...
useEffect(() => {
  ...
  return (
    <>
      <ModalStyled
        open={createDealContactModalState}
        onClose={() => onClose()}
...
export default CreateDealContactModal;