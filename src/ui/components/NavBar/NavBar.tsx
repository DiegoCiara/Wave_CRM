...
import { TitleContainer, TitleStyledHeadSec } from "../Title/Title.style";
import { TitleHeaderContainer } from "@styles/pagesStyle/deals.style";
    ...
    <Root style={props.style}>
      ...
      <AppBarStyled position="fixed">
        <ToolbarHeaderStyled>
          ...
          <HeaderLogoStyled src={"logo.png"} alt={"Wave"} />
      ...
      <ContentStyled style={{ marginLeft: navHover ? "104px" : "-6px" , transition: "0.5s"}}>
        {props.CurrentPage}
      </ContentStyled>
    </Root>
  );
